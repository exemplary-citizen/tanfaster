...
// including the "Explore more products" sibling list from the subcategory.
...
export const Route = createFileRoute(
  ...
  loader: async ({ params }) => {
    const [product, relatedProducts] = await Promise.all([
      getProductDetailsFn({ data: params.product }),
...
function ProductPage() {
  const { product: productData, relatedProducts } = Route.useLoaderData();
